...
- Phases 5 et 6 : procédure pilote écrite, paquet préversion construit localement, non notarisé. Il faut encore les deux Mac Logic et un assistant réellement utilisé par chaque pilote, des commandes musicales qualifiées et une identité Developer ID pour une distribution sans friction Gatekeeper. MCP Inspector qualifie l'échange protocolaire, sans remplacer ces essais.
